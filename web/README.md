...
del panel de actividad. Si una actividad contiene varios pasos, el panel muestra
la postura e instrucción actuales y el progreso de toda la secuencia. Al
terminar, «Ver resultado» conserva la sesión completada y «Volver a analizar
mi expresión» inicia otra sesión y un reconocimiento facial nuevos.
...
Durante la actividad se pueden mostrar puntos y líneas de postura y activar la
...
revocar una aceptación previa. En `CONSENT_MODE=demo` se muestra la política
provisional y el estudiante debe aceptarla. En producción se requiere una
política institucional aprobada y vigente, cargada por administración mediante
la API. Una cuenta demo existente puede recibir
